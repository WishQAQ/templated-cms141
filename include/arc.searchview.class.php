...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        {
            return "<span class=\"pages\">共1页，/".$this->TotalResult."条记录</span>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<span class=\"pages\">共0页，/".$this->TotalResult."条记录</span>\r\n";
        }
        $purl = $this->GetCurUrl();
        ...
        $infos = "<span class=\"pages\">共找到".$this->TotalResult."条记录/最大显示{$totalpage}页</span>";
        ...
        {
            $plist.="<input type='text' name='PageNo' style='width:28px;height:14px' value='".$this->PageNo."' />\r\n";
