...
else
{
    ...
    $digg = '<div class="single_views" onmouseout="ILike(this,false)" onmouseover="ILike(this,true)"><span class="textcontainer"><span class="votecount26536">'.$row['goodpost'].'</span></span> <span class="bartext voteid26536"><a style="cursor:pointer" id="aZanImg" onclick="postDigg(\'good\','.$id.')"></a></span><span class="text" id="spanZan">赞</span>
